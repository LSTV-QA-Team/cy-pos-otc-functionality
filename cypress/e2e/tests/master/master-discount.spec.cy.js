...
describe('Discounts', () => {
    ...
    it('Check Discount Page', () => {   
        ...
        cy.checkElementVisibility('.h-screen ', '1.2', 'Upon Navigating to Discount Type:', '"Discount Type" modal window was not visible or active.', assertionResults, failureMessages)

        cy.wait(2000)

        cy.checkHeaderTitle(':nth-child(1) > .text-\\[2rem\\]','1.2.1', 'Upon Navigating to Discount pager U/I', 'Discount Type', assertionResults, failureMessages)
    ...
    //         cy.checkElementVisibility('.shadow-lg', '2.1', 'Upon Clicking the "Save" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
    ...
    //                             cy.get('#discountdsc').type('Chicken')
    ...
    //                             cy.checkElementVisibility('.shadow-lg', '6.2.1', 'Upon Clicking the "No" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
    ...
    //                             cy.checkElementInvisibility('.shadow-lg', '40.3.1', 'Upon Clicking the "Yes" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)

    //                             // 40.3.2 Check if the active windows back to Pager U/I.
    //                             cy.checkHeaderTitle(':nth-child(1) > .text-\\[2rem\\]', '40.3.2', 'Upon clicking the "Yes" button', 'Discount', assertionResults, failureMessages)
    ...
    //                             cy.checkElementInvisibility('.shadow-lg', '49.2.1', 'Upon clicking the "OK" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
    ...
    //                             cy.checkElementVisibility('.shadow-lg', '4.2.1', 'Upon Clicking the "Save" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
    ...
    //             cy.contains('tbody > tr', specificdiscount.discount).within(() => {

    //                 cy.get('[data-icon="edit"][aria-hidden="true"]').click()
    //             })

    //             // 54.1 Check if modal window is visible.
    //             cy.checkElementVisibility('.shadow-lg', '54.1', 'Upon Clicking the "Edit" button:', 'The "Edit Discount" modal window was not visible or active.', assertionResults, failureMessages)

    //             // 54.1.1 Check correct modal title header.
    //             cy.checkHeaderTitle('.px-8', '54.1.1', 'Upon clicking the "Edit" button on pager UI', 'Edit Discount', assertionResults, failureMessages)
    ...
    //             cy.validateElements('discount-edit-el.json', '54.1.4 & 54.1.6', 'Upon clicking the "Add" button on pager U/I:', assertionResults, failureMessages)

    //             // 55. Clear "Description" textbox object. 
    //             cy.get('#discountdsc')
    //                 .should('have.value', specificdiscount.discount)
    //                 .clear()

    //             // 56. Edit the existing data. 
    //             cy.get('#discountdsc').type(specificdiscount.editdiscount)

    //             cy.get('#itmclacde').select(specificdiscount.editItemClass)
    ...
    //             cy.checkElementInvisibility('.shadow-lg', '57.2.1', 'Upon Clicking the "Update Data" button:', 'The "Edit Discount" modal window still visible', assertionResults, failureMessages)
    ...
    //             cy.checkLabelCaption('.h-\\[500px\\] > h1', 'Do you want to delete: ' + specificdiscount.editItemClass + ' ?', assertionResults, failureMessages);
    ...
    //             cy.get('#\\:re\\:')
    //                 .clear()
    //                 .type(specificdiscount.discount)
    //                 .type('{enter}');

    //             cy.wait(2000)
   
    //             cy.get('.MuiTableBody-root').contains(specificdiscount.discount).should('exist');
    //     })
