...
describe('Discounts', () => {
    ...
    it('Check Discount Page', () => {  
        ...
        cy.checkTableColumnTitle(['Actions', 'Discount'], '1.2.2', 'Upon Navigating to Discount Type pager U/I', assertionResults, failureMessages)
    ...
    it('Add Functionality', () => {
        ...
        cy.fixture('master-discount-data.json').then((data) => {
            ...
            cy.checkLabelCaption('.mb-2', '2.1.2', 'Upon clicking the "Add" button on pager U/I', 'Discount *', assertionResults, failureMessages)
                ...
                cy.get('#discde')
                  ...
                  .then(($input) => {
                    ...
                    if ($input.val() === "null") {
                        ...
                        cy.checkLabelCaption('.text-sm', '10.1', 'Upon clicking the "Save" button:', 'Discount * is required', assertionResults, failureMessages)
                        
                        cy.get('#discde').type('Food')
                        ...
                        cy.checkElementVisibility('.shadow-lg', '5.2.1', 'Upon Clicking the "No" button in "Cancel" modal:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
                        ...
                        cy.checkElementInvisibility('.shadow-lg', '5.3.1', 'Upon Clicking the "Yes" button in "Cancel" modal:', 'The "Add Discount" modal window was visible or active.', assertionResults, failureMessages)

                        cy.checkElementVisibility('.h-screen', '5.3.2', 'Upon clicking the "Yes" button, should back in Discount Pager U/I', assertionResults, failureMessages)
                        ...
                        cy.checkElementInvisibility('.shadow-lg', '8.2.1', 'Upon clicking the "Save" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
                        ...
                        cy.checkElementInvisibility('.shadow-lg', '14.2.1', 'Upon clicking the "Save" button:', 'The "Add Discount" modal window was not visible or active.', assertionResults, failureMessages)
    ...
    it('Edit Functionality', () => {
        ...
        const specificdiscount = data[4];
            ...
            cy.checkElementVisibility('.shadow-lg', '19.1', 'Upon Clicking the "Edit" button:', '"Edit Discount" modal window was not visible or active.', assertionResults, failureMessages)

            cy.checkHeaderTitle('.px-8', '19.1.1', 'Upon clicking the "Edit" button on pager UI', 'Edit Discount', assertionResults, failureMessages)

            cy.checkLabelCaption('.mb-2', '19.1.2', 'Upon clicking the "Edit" button on pager U/I', 'Discount *', assertionResults, failureMessages)
            ...
            cy.get('#discde').type(specificdiscount.editdiscount)
            ...
            cy.checkElementInvisibility('.shadow-lg', '22.2.1', 'Upon Clicking the "Update" button:', 'The "Edit Discount" modal window still visible', assertionResults, failureMessages)
        ...
        cy.fixture('master-discount-data.json').then((data) => {
            ...
            for (const key in data) {
                ...
                if (data[key].onlyDelete === true) {
                    ...
                    cy.contains('tbody > tr', data[key].editdiscount).within(() => {
                    ...
                    cy.checkLabelCaption('.h-\\[500px\\] > h1', '41.3', 'Do you want to delete: ' + data[key].editdiscount + ' ?', assertionResults, failureMessages);
        ...
        cy.fixture('master-discount-data.json').then((data) => {
            ...
            for (const key in data) {
                ...
                if (data[key].onlySearchVal === true) {
                    ...
                    .should('be.enabled')
                    .clear()
                    .type(data[0].discount)

                    cy.wait(2000)
    
                    cy.get('.MuiTableBody-root').contains(data[0].discount).should('exist')
